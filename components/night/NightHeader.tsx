...
import { localeToRoute } from "../../lib/i18n/types.ts";
 ...
 * homepage, viz I18nProvider) + přepínač zpět na metro, pak H1 se SEO
 * nadpisem (zadání bod 17) a krátký podtitulek. Analogie
 * components/AppHeader.tsx (tam je stejná trojice tlačítek, jen s
 * opačným směrem přepínače).
 */
export default function NightHeader({ mainHeading }: NightHeaderProps) {
    ...
    <header className="px-4 pt-5 sm:pt-6">
      <div className="mx-auto flex w-full max-w-2xl items-center justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          ...
          <VulgarToggle />
          <HeaderModeSwitchLink href={localeToRoute[locale]} label={nightDict.backToMetroLink} direction="to-day" />
        </div>
      </div>
