...
const seo = getNightSeoContent("en");
const PATH = "/en/night-transport";
...
export default function Page() {
  const jsonLd = buildWebApplicationJsonLd({ locale: "en", siteUrl: SITE_URL, path: PATH, name: "KdeJeMetro.cz – Night transport", description: seo.description });
  const breadcrumbJsonLd = buildBreadcrumbListJsonLd(
    [
      { name: "KdeJeMetro.cz", path: "/en" },
