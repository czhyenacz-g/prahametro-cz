...
const seo = getNightSeoContent("cs");
const PATH = "/nocni-mhd";
...
export default function Page() {
  const jsonLd = buildWebApplicationJsonLd({ locale: "cs", siteUrl: SITE_URL, path: PATH, name: "KdeJeMetro.cz – Noční MHD", description: seo.description });
  const breadcrumbJsonLd = buildBreadcrumbListJsonLd(
    [
      { name: "KdeJeMetro.cz", path: "/" },
