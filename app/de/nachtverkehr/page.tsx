...
const seo = getNightSeoContent("de");
const PATH = "/de/nachtverkehr";
...
export default function Page() {
  const jsonLd = buildWebApplicationJsonLd({ locale: "de", siteUrl: SITE_URL, path: PATH, name: "KdeJeMetro.cz – Nachtverkehr", description: seo.description });
  const breadcrumbJsonLd = buildBreadcrumbListJsonLd(
    [
      { name: "KdeJeMetro.cz", path: "/de" },
